<?php 
  class GMTrader Extends GModel{
    ...
    public function addTrader($userId,$name,$gender,$cityId,$countryId,$registrationDate)
    {
    ...
    public function updateTrader($userId,$name,$gender,$cityId,$countryId,$registrationDate)
    {
    ...
    {
      $this->db->query($this->mtablename, array_merge($fields, ["mtraders.id AS mtraderid", "mtraders.name","gender","city_id","city.country_id","city.name AS cityname","country.name AS countryname","username","email","telephone","trade_id","emailverified","telephoneverified"]));
    ...
    {
      return $this->dbcrud->insert('cart',
         array(
    ...
    { 
      return $this->dbcrud->update('cart',
        [
          'quantity' => $quantity,
        ],
        [
